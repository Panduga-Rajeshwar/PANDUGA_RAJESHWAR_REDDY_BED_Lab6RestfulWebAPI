...
import com.greatlearning.studentmanagement.service.FetchedDecoratedUser;
...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().requestMatchers("/", "/readstudentlist", "/students/addform", "/403")
				...
				.successForwardUrl("/readstudentlist").permitAll().and().logout().logoutSuccessUrl("/login").permitAll()
